...
<!-- 取出資料結束。 -->
  <div class="mt-3 col-md-12 col-lg-4 col row justify-content-center">
    <div class="card border border-warning" style="width:400px">
      <img  class="card-img-top mx-auto" src="./upimg/<?= $read[0][0]["jpge_where"]?>" alt="Card image" style="width:261px; height:261px;">
      <div class="card-body">
...
<div class="mt-3 col-md-12 col-lg-4 col row justify-content-center">
  <div class="card border border-warning" style="width:400px">
    <img class="card-img-top mx-auto" src="./upimg/<?= $read[1][0]["jpge_where"]?>" alt="Card image" style="width:261px; height:261px;">
    <div class="card-body">
...
<div class="mt-3 col-md-12 col-lg-4 col row justify-content-center">
  <div class="card border border-warning" style="width:400px">
    <img class="card-img-top mx-auto" src="./upimg/<?= $read[2][0]["jpge_where"]?>" alt="Card image" style="width:261px; height:261px;">
    <div class="card-body ">
